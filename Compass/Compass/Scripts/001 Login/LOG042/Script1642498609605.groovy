...
WebUI.click(findTestObject('001 Login/023. button profile'))

WebUI.click(findTestObject('001 Login/024. button ganti akun'))

WebUI.click(findTestObject('001 Login/025. change to admin'))
